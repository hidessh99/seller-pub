...
wget https://raw.githubusercontent.com/hidessh99/seller-pub/main/inst-xray-opok.sh && chmod +x inst-xray-opok.sh && ./inst-xray-opok.sh
sleep 2
clear
...
#package tambahan
wget -q -O /usr/bin/add-ws "https://raw.githubusercontent.com/hidessh99/seller-pub/main/add-vmess-opok.sh" && chmod +x /usr/bin/add-ws
